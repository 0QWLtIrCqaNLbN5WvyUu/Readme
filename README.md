...
- ASP.NET Coreを用いたWebアプリの開発が可能です。
    - MVCアーキテクチャ | RESTful設計 | 依存性注入(DI) | SOLID原則 | OOP設計(Observer/State/Template Method/Strategy/Unit of Work/Null Object/Composite/Decorator/Command etc…) | 自動テスト などを活用し、保守性の高い設計・実装をします。
