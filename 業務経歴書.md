...
##### 【使用技術】
AWS(ECS/CloudFront/WAF/ALB/Aurora/ElastiCache(Redis)/S3/OpenSearch//Kinesis Data Firehose/Secrets Manager/API Gateway/Lambda/CloudWatch/SNS/ACM/Route 53) |    
