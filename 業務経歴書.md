...
C#(ASP.NET Core/Entity Framework/xUnit) | JavaScript |  
OpenAI API | SendGrid | Jenkins  
##### 【業務】
...
##### 【使用技術】
AWS(ECS/CloudFront/WAF/ALB/Aurora/ElastiCache(Redis)/Kinesis Data Firehose/Secrets Manager/API Gateway/Lambda/S3/OpenSearch/CloudWatch/SNS/ACM/Route 53) |    
...
##### **【使用技術】**  
AWS(VPC/ALB/EC2/RDS(MySQL)/S3/IAM/SES/CloudWatch/SNS/Route 53/ACM) |   
C#(ASP.NET Core | xUnit | Xamarin Forms | WPF) | PHP(Laravel) | Java | Kotlin | JavaScript |   
SQLite | Docker | Jenkins  
##### **【業務】**  
