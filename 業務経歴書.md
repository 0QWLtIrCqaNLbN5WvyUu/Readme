...
##### 【使用技術】
AWS(ECS/CloudFront/WAF/ALB/Kinesis Data Firehose/Secrets Manager/API Gateway/Lambda/Aurora/ElastiCache(Redis)/S3/OpenSearch/CloudWatch/SNS/ACM/Route 53) |    
