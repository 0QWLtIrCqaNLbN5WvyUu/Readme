...
##### 【使用技術】
AWS(ECS/CloudFront/WAF/ALB/Aurora/API Gateway/ElastiCache(Redis)/S3/OpenSearch//Kinesis Data Firehose/Secrets Manager/Lambda/CloudWatch/SNS/ACM/Route 53) |    
